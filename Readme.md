...
# Descrição: O Vagrantfile provisiona um servidor Rocky Linux 9 (RHEL)
#            para ser instalado o Elastick Stack (Elasticsearch/Kibana/Logstash/Beats).
#            Os scripts automatiza a instalação e configuração dos produtos do ELK Stack 
#            e de alguns pacotes e configurção do sistema.
